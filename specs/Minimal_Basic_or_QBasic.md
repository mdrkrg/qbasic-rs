...
![qbasic-fig1](./public/upload_d170cf4333ec6a0b42767e3528ecc2e7.png)
...
![qbasic-fig2](./public/upload_e043d3debdd9bdb83c655514cbca5074.png)
*Figure1*
...
![](./public/upload_64fad2b231d047282b69e087b6017390.png)
*Figure2*
...
1. LET m = p + q*t
![](./public/upload_f2fdcef9fb97924b4900731b90af1023.png)
2. IF m > max THEN n
![](./public/upload_e7144ed27af72d3929c2603b4f4a7ac9.png)
3. GOTO n
![](./public/upload_7ed6c2dcc0f1231c19f31fb17f1c20f0.png)
4. PRINT p + q*t
![](./public/upload_9134258130df810c223f71260ff2b7a3.png)
...
![](./public/upload_b35c7cd226e4ec1b8ecfc499630a2a40.png)
...
![](./public/upload_41101b054e80645e3c0d9f0f135231ce.png)
...
![](./public/upload_4857fa63d6d91662777d162a94df7ac9.png)
...
![](./public/upload_8afb5addd4c71f47fde54b4e54d40614.png)
...
![](./public/upload_3131ddd4477169808d399115dc16b212.png)
...
## 2. Bonus Part: Compiling BASIC `LET` Statements to Y86-64

> **This part of the content is independent of the BASIC score, with a total of 10 points. But the maximum score for the entire project is still 100 points.**

### 2.1. Background

**How computer execute the code we write in C++/BASIC?**

- Acutally, computers don't understand C++ or BASIC statement. They only understand machine code - a stream of binary `1`s and `0`s(like `01100011...`). But it is hard for human to read and write.
...
- **Stack**
    ...
    - You can also refer to [this explanation](./references/Lab2_Y86-64模拟器_1761194038284.md#%E6%A0%88%E6%93%8D%E4%BD%9C) in lab2.

- **[Essential Instructions for this Project](./references/Lab2_Y86-64模拟器_1761194038284.md#%E6%8C%87%E4%BB%A4%E7%BC%96%E7%A0%81%E5%92%8C%E5%8A%9F%E8%83%BD)**:
    - Data Movement:
...
This background should be sufficient to understand the goal of the following project, and **you can also refer to [the lab manual for lab2](./references/Lab2_Y86-64模拟器_1761194038284.md)**. **At the end of this part, there is a detailed example to explain.**
...
main:
    ...
    popq %rax                  # Pop A
    addq %rbx, %rax            # A + 5
    rmmovq %rax, var_B(%rdi)   # Store in B
